<section id="progress-showcase" class="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-deep-green-900 via-deep-green-800 to-emerald-premium-900 overflow-hidden">
    ...
    <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
            ...
            <div class="reveal order-2 lg:order-1">
                <div class="relative rounded-[2rem] bg-white/5 backdrop-blur-xl border border-white/10 p-4 sm:p-6 lg:p-8 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)]">
                    ...
                    <!-- Dashboard header -->
                    <div class="flex items-center justify-between mb-6 sm:mb-8 mt-2 gap-3">
                        <div>
                            <p class="text-soft-mint-100/70 text-xs sm:text-sm font-semibold">لوحة تقدم الطالب</p>
                            <p class="text-white font-extrabold text-base sm:text-xl mt-0.5">شاهد تطورك مع كل تلاوة</p>
                        </div>
                        <div class="flex items-center gap-2">
                            ...
                            <span class="hidden sm:inline-block px-3 py-1.5 rounded-full bg-white/5 text-soft-mint-100/60 text-xs font-bold border border-white/10">أسبوعي</span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-3 mb-6 sm:mb-8">
                        ...
                        @endphp
                        @foreach ($kpis as $kpi)
                            <div class="bg-white/5 rounded-2xl border border-white/10 p-3 sm:p-4 text-center">
                                <p class="text-lg sm:text-xl font-black {{ $kpi[2] }}">{{ $kpi[1] }}</p>
                    ...
                    <!-- Chart -->
                    <div class="bg-white/5 rounded-2xl border border-white/10 p-4 sm:p-5 mb-6 sm:mb-8">
                    ...
                    <!-- Recent recording -->
                    <div class="bg-white/5 rounded-2xl border border-white/10 p-4 sm:p-5 flex items-center gap-3 sm:gap-4">
                        ...
                        <div class="flex-1 min-w-0">
                            <p class="text-white font-extrabold truncate">آخر تسجيل — سورة الرحمن</p>
            ...
            <div class="order-1 lg:order-2">
                <span class="inline-block px-4 py-1.5 rounded-full bg-white/10 border border-white/15 text-soft-mint-100 text-sm font-bold mb-4 sm:mb-5">متابعة التقدم</span>
                ...
                <div class="reveal mt-8 sm:mt-10" style="--reveal-delay: 300ms">
                    <a href="{{ route('register') }}"
                       class="inline-flex items-center gap-3 px-8 sm:px-9 py-3.5 sm:py-4 rounded-xl sm:rounded-2xl font-extrabold text-base sm:text-lg text-white bg-gradient-to-l from-emerald-premium-500 to-emerald-premium-600 shadow-glow-md hover:shadow-glow-lg hover:-translate-y-1 transition-all duration-300">
                        ابدأ المتابعة الآن
                    </a>
                </div>
            </div>
