<section id="home" class="relative min-h-[100svh] flex items-center overflow-hidden bg-gradient-to-br from-deep-green-900 via-deep-green-800 to-emerald-premium-900">
    <!-- Background layers -->
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-20 w-full">
        <div class="grid lg:grid-cols-2 gap-14 lg:gap-20 items-center">

            <!-- Text content -->
            <div class="text-center lg:text-right order-2 lg:order-1">
                <div class="reveal">
                    <span class="inline-flex items-center gap-2.5 px-5 py-2.5 rounded-full glass-dark text-soft-mint-100 text-sm font-semibold border border-white/15">
                        <span class="w-2 h-2 rounded-full bg-emerald-premium-400 animate-pulse"></span>
                        رحلتك لإتقان كتاب الله تبدأ هنا
                    </span>
                </div>

                <h1 class="reveal mt-7 text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-black text-white leading-[1.15] tracking-tight" style="--reveal-delay: 100ms">
                    أتقن تلاوة
                    <span class="text-gradient-emerald block mt-1 pb-2">القرآن الكريم</span>
                    خطوة بخطوة
                </h1>

                <p class="reveal mt-7 text-lg sm:text-xl text-soft-mint-100/85 leading-relaxed max-w-xl mx-auto lg:mx-0 font-medium" style="--reveal-delay: 200ms">
                    منصة تعليمية متكاملة تساعدك على التعلّم، تسجيل تلاوتك، متابعة تقدمك والحصول على تقييم مباشر من معلميك.
                </p>

                <div class="reveal mt-10 flex flex-col sm:flex-row gap-4 justify-center lg:justify-start" style="--reveal-delay: 300ms">
                    <a href="{{ route('register') }}"
                       class="group inline-flex items-center justify-center gap-3 px-9 py-4 rounded-2xl font-extrabold text-lg text-white bg-gradient-to-l from-emerald-premium-500 to-emerald-premium-600 shadow-glow-md hover:shadow-glow-lg hover:-translate-y-1 transition-all duration-300">
                        ابدأ التعلم الآن
                    ...
                    <a href="#about"
                       class="inline-flex items-center justify-center gap-3 px-9 py-4 rounded-2xl font-extrabold text-lg text-white glass-dark border border-white/20 hover:bg-white/15 hover:-translate-y-1 transition-all duration-300">
                        اكتشف الأكاديمية
                    </a>
                </div>

                <!-- Trust indicators -->
                <div class="reveal mt-12 flex items-center justify-center lg:justify-start gap-8" style="--reveal-delay: 400ms">
                    ...
                    <div class="flex -space-x-2 space-x-reverse">
                        @foreach (['#10B981', '#0F766E', '#D4AF37', '#34D399'] as $i => $color)
                            <div class="w-9 h-9 rounded-full border-2 border-deep-green-800 flex items-center justify-center text-white text-xs font-bold" style="background: {{ $color }}">ط</div>
                        @endforeach
                    </div>
            ...
            <!-- Dashboard Mockup -->
            <div class="relative order-1 lg:order-2 flex justify-center lg:justify-end" data-tilt>
                <div class="relative w-full max-w-md">
                    <!-- Glow behind card -->
                    <div class="absolute -inset-6 bg-emerald-premium-500/20 rounded-[3rem] blur-3xl"></div>

                    <!-- Main card -->
                    <div class="relative rounded-[2rem] bg-white/95 backdrop-blur-2xl border border-white/60 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.5)] p-6 sm:p-7">
                        <!-- Header -->
                    ...
                    <!-- Floating cards -->
                    <div class="absolute -right-3 sm:-right-6 -top-6 animate-float" style="animation-delay: 0s">
                    ...
                    <div class="absolute -left-3 sm:-left-8 top-1/4 animate-float-slow" style="animation-delay: 0.8s">
                        <div class="glass rounded-2xl shadow-premium px-4 py-3 flex items-center gap-3">
                            <span class="text-2xl">🎧</span>
                            <div>
                    ...
                    <div class="absolute -right-2 bottom-24 animate-float-very-slow" style="animation-delay: 1.6s">
                        <div class="glass rounded-2xl shadow-premium px-4 py-3 flex items-center gap-3">
                            <span class="text-2xl">📖</span>
                            <div>
