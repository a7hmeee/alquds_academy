<section id="memorial" class="relative py-16 sm:py-20 lg:py-28 bg-gradient-to-br from-deep-green-900 via-deep-green-800 to-emerald-premium-900 overflow-hidden">
    <div class="absolute inset-0 pattern-islamic-dark opacity-40"></div>
    <div class="absolute -top-24 -right-24 w-96 h-96 bg-gold-accent-500/10 rounded-full blur-[100px] pointer-events-none"></div>
    <div class="absolute -bottom-24 -left-24 w-96 h-96 bg-emerald-premium-500/15 rounded-full blur-[100px] pointer-events-none"></div>

    <div class="relative max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div class="reveal mx-auto mb-6 w-12 h-12 rounded-2xl bg-gradient-to-br from-gold-accent-400 to-gold-accent-600 flex items-center justify-center shadow-glow-md rotate-3 group hover:rotate-0 transition-transform duration-500">
        ...
        <div class="reveal mt-8 sm:mt-10" style="--reveal-delay: 300ms">
            <div class="flex items-center justify-center gap-4 text-soft-mint-100/60">
                <div class="h-px w-16 sm:w-24 bg-gradient-to-l from-gold-accent-400/40 to-transparent"></div>
                <p class="text-sm sm:text-base font-semibold">رحمها الله وغفر لها وأسكنها فسيح جناته</p>
                <div class="h-px w-16 sm:w-24 bg-gradient-to-r from-gold-accent-400/40 to-transparent"></div>
            </div>
        </div>
    </div>
</section>
