<section id="cta" class="relative py-20 lg:py-28 bg-warm-white overflow-hidden">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="reveal relative rounded-[2.5rem] bg-gradient-to-br from-deep-green-800 via-deep-green-900 to-emerald-premium-900 overflow-hidden p-10 sm:p-16 lg:p-20 text-center shadow-premium">
            ...
            <div class="absolute -bottom-32 -left-32 w-[26rem] h-[26rem] bg-gold-accent-500/10 rounded-full blur-[100px]"></div>
            <div data-particles class="absolute inset-0 overflow-hidden pointer-events-none"></div>

            <!-- Decorative Quran book glow -->
            <div class="absolute top-10 left-1/2 -translate-x-1/2 w-40 h-40 opacity-10">
                <svg class="w-full h-full text-white animate-float" fill="currentColor" viewBox="0 0 24 24">
