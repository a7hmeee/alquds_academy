...
return new class extends Migration
{
    ...
    {
        Schema::create('memorization_assignments', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('assignment_type'); // new_memorization, close_revision, far_revision, consolidation, test
            ...
            $table->string('status')->default('draft'); // draft, assigned, in_progress, submitted, reviewed, completed, needs_revision, cancelled
            ...
            $table->index(['circle_id', 'student_id', 'status']);
            $table->index('due_at');
        });
    }
    ...
    {
        Schema::dropIfExists('memorization_assignments');
    }
};
